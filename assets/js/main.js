...
// We obtain the current theme thart the interface has by validating the light-theme class
...
// Activate / desactivate the manually with the button
themeButton.addEventListener('click', () => {
    // Add or remove the light / icon theme
    document.body.classList.toggle(lightTheme)
    themeButton.classList.toggle(iconTheme)
    // We save the theme and current icon that the iser chose
